...
:::note
Lorem ipsum dolor sit amet consectetur. Porta a orci elit malesuada. Fusce nulla quisque erat amet. Scelerisque orci odio ut in nullam vitae gravida aliquam pulvinar. `code sample`
:::
...
:::caution
This should look the same as WARNING. Lorem ipsum dolor sit amet consectetur. Porta a orci elit malesuada. Fusce nulla quisque erat amet. Scelerisque orci odio ut in nullam vitae gravida aliquam pulvinar.
:::
...
<CheckListItem>
  ...
  * Node
  * npm
  * React <CodeBadge>npm install react@18.2.0</CodeBadge>
  * React DOM <CodeBadge>npm install react-dom@18.0.2</CodeBadge>
